...
import { increaseItemQuantity, removeItemFromCart, decreaseItemQuantity } from '../../app/cartSlice.js';
...
const CartItem = ({
  ...
  const onRemoveItem = () => {
    dispatch(removeItemFromCart({ id, title, text, img, color, shadow, price, cartQuantity }));
  };
