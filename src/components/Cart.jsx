...
const Cart = () => {
  ...
  const ifCartStatus = useSelector(selectCartStatus);
  ...
  const onOpenCart = () => {
    dispatch({ type: setCloseCart.type, payload: true });
  }
  ...
  return (
    <>
      ...
      >
        ...
        >
          <CartCount onOpenCart={onOpenCart} onClearCartItems={onClearCartItems} totalQuantity={totalQuantity} />
          {items.length === 0 ? (
            <CartEmpty />
          ) : (
            <div>
